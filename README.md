...
## 🎉 News
- **[04-01.2025]** We're excited to share that the data and code for the ActionStudio framework are now open-source. Discover more in our [paper](https://arxiv.org/abs/2503.22673) and explore the [GitHub code under xLAM](https://github.com/SalesforceAIResearch/xLAM/blob/main/ActionStudio_README.md). We look forward to your feedback!
