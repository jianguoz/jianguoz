...
## 🎉 News
- **[09.2024]** Check our new work [xLAMM: A Family of Large Action Models to Empower AI Agent Systems](https://arxiv.org/abs/2409.03215), which shows Top performance on several challenging benchmarks. See also the [XLAM Repo](https://t.co/iBAp3MgXGo), [HuggingFace Model Collections](https://huggingface.co/collections/Salesforce/xlam-models-65f00e2a0a63bbcd1c2dade4), and [Project Webpage](https://www.salesforceairesearch.com/projects/xlam-large-action-models).
