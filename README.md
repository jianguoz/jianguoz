...
## 🎉 News
- **[09.2024]** Check our latest work [xLAMM: A Family of Large Action Models to Empower AI Agent Systems](https://arxiv.org/abs/2409.03215), which demonstrates top-tier performance across multiple challenging benchmarks and scenarios. Explore more through the [XLAM GitHub Repo](https://t.co/iBAp3MgXGo), [HuggingFace Model Collections](https://huggingface.co/collections/Salesforce/xlam-models-65f00e2a0a63bbcd1c2dade4) and [Project Webpage](https://www.salesforceairesearch.com/projects/xlam-large-action-models).
